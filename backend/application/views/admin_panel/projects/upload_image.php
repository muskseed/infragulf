         ...
         <div class="box-body">
            ...
            <!-- <div class="container"> -->
               ...
               //form open
                  ...
                  echo form_open_multipart('admin_panel/Projects/image_upload', $form_attributes);
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-md-3" style="margin: 10px 30px 10px 15px;">
                              ...
                              ?>
                                <a href="<?= BASE_URL ?>admin_panel/Projects/featured_image/<?= $value['product_id']; ?>/<?= $value['id']; ?>" class="btn btn-primary" style="float: left;margin: 5px 0px 0px 5px;">Featured</a>
                                <a href="<?= BASE_URL ?>admin_panel/Projects/delete_image/<?= $value['id']; ?>" class="btn btn-danger" style="float: right;margin: 5px 0px 0px 5px;">Delete</a>
                              <?php
