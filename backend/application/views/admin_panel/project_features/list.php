...
<head>  
  ...
  <title><?= COMPANY_NAME; ?> | Project Feature List</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Project Feature List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url(); ?>admin_panel/Project_features/frontend_view/add" class="btn btn-success" style="float: right;width: 100px;"><i class=""></i> Add</a>
            </div>
  ...
  $(document).ready(function() {
      $('#country_list').DataTable({
        "lengthMenu": [[25, 50, 100, -1], [25, 50, 100, "All"]],
          "ajax": {
              url : "<?php echo base_url("admin_panel/Project_features/frontend_list") ?>",
              type : 'POST'
          },
      });
  });
...
<script type="text/javascript">
  $(document).ready(function(){
    <?php if ($this->session->flashdata('success') == 'yes') { ?>
      new PNotify({
          title: 'Success!',
          text: 'Feature Added Succesfully',
          type: 'success'
      });
    <?php } ?>
