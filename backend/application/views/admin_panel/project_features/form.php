...
<head>
  ...
  <title><?= COMPANY_NAME; ?> | Project Feature Form</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>admin_panel/Property_type"><?php echo $this->session->userdata('module_name'); ?></a></li>
      </ol>
    </section>
         ...
         <div class="box-body">
            ...
            <!-- Container of Form -->
               ...
               //form open
                  ...
                  echo form_open(isset($form_edit_data[0]['id']) ? 'admin_panel/Project_features/form_action/'.$form_edit_data[0]['id'] : 'admin_panel/Project_features/form_action', $form_attributes);

               ?>
                <div class="row">

                  <div class="form-group col-md-6">
                    <label class="col-md-4 control-label">Feature Name:<span style="color: red;">*</span></label>

                    <div class="col-md-8">
                      <input type="text" class="form-control" name="name" id="name" value="<?php echo isset($form_edit_data[0]['name']) ? $form_edit_data[0]['name'] : ''; ?>" placeholder="Enter Feature Name">
                    </div>
                  </div>
                </div>
