...
<head>  
  ...
  <title><?= COMPANY_NAME; ?> | Sell Registration List</title>
  ...
  $(document).ready(function() {
      $('#country_list').DataTable({
        "lengthMenu": [[25, 50, 100, -1], [25, 50, 100, "All"]],
          "ajax": {
              url : "<?php echo base_url("admin_panel/sell_registration/frontend_list") ?>",
              type : 'POST'
          },
      });
  });
