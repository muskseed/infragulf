         ...
         <div class="box-body">
            ...
            <!-- Container of Form -->
               ...
               //form open
                  ...
                  echo form_open_multipart(isset($edit_data[0]['id']) ? 'admin_panel/team/form_action/'.$edit_data[0]['id'] : 'admin_panel/team/form_action', $form_attributes);
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="email" id="email" value="<?php echo isset($edit_data[0]['email']) ? $edit_data[0]['email'] : ''; ?>" placeholder="Enter Email ID">
                            </div>
                        </div>
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo isset($edit_data[0]['mobile']) ? $edit_data[0]['mobile'] : ''; ?>" placeholder="Enter Mobile Number">
                            </div>
                        </div>

                        <div class="form-group col-md-6">
                            <label class="col-md-4 control-label">Whatsapp :<span style="color: red;">*</span></label>

                            <div class="col-md-8">
                            <input type="text" class="form-control" name="whatsapp" id="whatsapp" value="<?php echo isset($edit_data[0]['whatsapp']) ? $edit_data[0]['whatsapp'] : ''; ?>" placeholder="Enter Whatsapp">
                            </div>
                        </div>
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <textarea name="description" id="description" cols="50" rows="4"><?php echo isset($edit_data[0]['description']) ? $edit_data[0]['description'] : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>  
