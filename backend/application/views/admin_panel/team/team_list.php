        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url(); ?>admin_panel/team/frontend_view/add" class="btn btn-success" style="float: right;width: 100px;"><i class=""></i> Add</a>
            </div>
  ...
  $(document).ready(function() {
      oTableStaticFlow = $('#country_list').DataTable({
        "lengthMenu": [[25, 50, 100, -1], [25, 50, 100, "All"]],
          "ajax": {
              url : "<?php echo base_url("admin_panel/team/frontend_list") ?>",
              type : 'POST'
          },
          "aoColumnDefs": [{
              'bSortable': false,
  ...
  $(document).on('click', '#delete_all', function () {
    ...
    if (delete_id.length === 0) {
      ...
      if (confirm("Are you sure?")) {
        $.ajax({
          url : "<?php echo base_url("admin_panel/team/delete_all") ?>",
          type: "POST",
          data: {delete_id : delete_id},
          dataType: "json",
          success: function(results){
            if(results.status == 'success'){
              window.location = "<?php echo base_url('admin_panel/team') ?>";
            }else{
              alert(results.msg);
            }
          }
