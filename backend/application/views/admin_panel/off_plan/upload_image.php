    ...
    <section class="content">
      ...
      <div class="box">
         <div class="box-header with-border">
            <h3 class="box-title">Uplaod Image</h3>
         ...
         <div class="box-body">
            ...
            <!-- <div class="container"> -->
               ...
               //form open
                  ...
                  echo form_open_multipart('admin_panel/off_plan/image_upload', $form_attributes);
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-md-3" style="margin: 10px 30px 10px 15px;">
                               <img src="<?= BASE_URL.PRODUCT_THUMB_IMAGE.$value['image_name']; ?>" width="300" height="300">
                              <?php 
                                if($value['featured_image'] == 0){
                              ?>
                                <a href="<?= BASE_URL ?>admin_panel/off_plan/featured_image/<?= $value['product_id']; ?>/<?= $value['id']; ?>" class="btn btn-primary" style="float: left;margin: 5px 0px 0px 5px;">Featured</a>
                                <a href="<?= BASE_URL ?>admin_panel/off_plan/delete_image/<?= $value['id']; ?>" class="btn btn-danger" style="float: right;margin: 5px 0px 0px 5px;">Delete</a>
                              <?php
                               }if($value['featured_image'] == 1){
                                echo '<button class="btn btn-success" style="float: center;margin: 5px 0px 0px 5px;">Default Image (Featured)</button>'; 
                               }
                               ?> 
                            </div>
                        <?php
