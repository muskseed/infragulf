...
<head>  
  ...
  <title><?= COMPANY_NAME; ?>| Cart List</title>
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              ...
              <table class="table table-bordered table-striped table-hover">
                <thead>
                  <th></th>
                  <th>Total Gross Weight : <?php echo $total_gross_weight; ?></th>
                  <th>Total Net Weight : <?php echo $total_net_weight; ?></th>
  ...
  $(document).ready(function() {
      ...
      $('#country_list').DataTable({
        "lengthMenu": [[25, 50, 100, -1], [25, 50, 100, "All"]],
          "ajax": {
              url : "<?php echo base_url("admin_panel/Users/cart_list_data") ?>/"+user_id,
              type : 'POST'
          },
      });
  });
