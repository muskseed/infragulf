         ...
         <div class="box-body">
            ...
            <!-- Container of Form -->
               ...
               //form open
                  ...
                  echo form_open(isset($form_edit_data[0]['id']) ? 'admin_panel/Property_type/form_action/'.$form_edit_data[0]['id'] : 'admin_panel/Property_type/form_action', $form_attributes);

               ?>
                <div class="row">

                  <div class="form-group col-md-6">
                    <label class="col-md-4 control-label">Property Name:<span style="color: red;">*</span></label>

                    <div class="col-md-8">
                      <input type="text" class="form-control" name="property_name" id="property_name" value="<?php echo isset($form_edit_data[0]['property_name']) ? $form_edit_data[0]['property_name'] : ''; ?>" placeholder="Enter Property Name">
                    </div>
                  </div>
                </div>
