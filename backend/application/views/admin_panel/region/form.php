...
<head>
  ...
  <title><?= COMPANY_NAME; ?> | Region Form</title>
         ...
         <div class="box-body">
            ...
            <!-- Container of Form -->
               ...
               //form open
                  ...
                  echo form_open(isset($form_edit_data[0]['id']) ? 'admin_panel/Region/form_action/'.$form_edit_data[0]['id'] : 'admin_panel/Region/form_action', $form_attributes);

               ?>
                <div class="row">

                  <div class="form-group col-md-6">
                    <label class="col-md-4 control-label">Region Name:<span style="color: red;">*</span></label>

                    <div class="col-md-8">
                      <input type="text" class="form-control" name="name" id="name" value="<?php echo isset($form_edit_data[0]['name']) ? $form_edit_data[0]['name'] : ''; ?>" placeholder="Enter Region Name">
                    </div>
                  </div>
                </div>
