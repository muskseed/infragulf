        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url(); ?>admin_panel/Region/frontend_view/add" class="btn btn-success" style="float: right;width: 100px;"><i class=""></i> Add</a>
            </div>
  ...
  $(document).ready(function() {
      $('#country_list').DataTable({
        "lengthMenu": [[25, 50, 100, -1], [25, 50, 100, "All"]],
          "ajax": {
              url : "<?php echo base_url("admin_panel/Region/frontend_list") ?>",
              type : 'POST'
          },
      });
  });
