...
<html lang="en">
  <head>   
    <title>Get the Best Deals on Luxury Villas, Apartments in Dubai</title>
    <meta name="description" content="Looking to buy luxurious villas, vista homes, apartments in Dubai? We have a wide selection of properties at affordable prices. Call +971 52 194 0000 now.">
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
          <div class="text-center">
            <div class="hading-section">
              <h1 class="title">Buy <span>Properties</span></h1>
              <p class="title-text mt-1">
                Search and find new & featured properties in Dubai. We make it easy, fast, and cost-effective to search for all available properties
              </p>              
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-6">
              <div class="filter-list p-relative text-right">
                ...
                <ul class="filter-box text-left">
                  <li>
                    <a href="<?php echo base_url(); ?>buy?sort_by=newest" value="Newest">Newest</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>buy?sort_by=high_low" value="Price (High - Low)">Price (High - Low)</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>buy?sort_by=low_high" value="Price (Low - High)">Price (Low - High)</a>
                  </li>
                </ul>
              </div>
            </div>
 ...
 ?>
  ...
  <script>
    $(".region_call , .property_call , .price_range , .bedroom_call").click(function(){
      ...
      window.location = "<?php echo base_url(); ?>buy?region_call="+region_call+"&property_call="+property_call+"&price_range="+price_range+"&bedroom_call="+bedroom_call;
    })

    $(".newest_order").click(function(){
      var newest_order = $(".newest_order").val();
      console.log(newest_order);
    })
  </script>
  </body>
</html>